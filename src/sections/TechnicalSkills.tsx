...
const TechnicalSkills = () => {
  return (
    <section className="relative mt-20 min-h-screen px-10">
      {/* title */}
      <div className="ml-16">
      ...
      <div className="mt-16 h-screen">
        <div className="border-t-secondary/20 text-secondary flex items-center justify-between border-t pt-8 font-medium">
